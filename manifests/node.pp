...
#  }
  ...
  if ($::openshift_origin::use_v2_carts == false or $::openshift_origin::development_mode == true) {
    package { [
    ...
    if( $::openshift_origin::development_mode == false ) {
  ...
  if ($::openshift_origin::use_v2_carts == true) {
